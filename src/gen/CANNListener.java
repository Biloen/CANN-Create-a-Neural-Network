...
public interface CANNListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterBoolIdentifier(CANNParser.BoolIdentifierContext ctx);
	/**
	 * Exit a parse tree produced by the {@code boolIdentifier}
	 * labeled alternative in {@link CANNParser#boolean_expr}.
	 * @param ctx the parse tree
	 */
	void exitBoolIdentifier(CANNParser.BoolIdentifierContext ctx);
	/**
	 * Enter a parse tree produced by the {@code greaterThanComparison}
	 * labeled alternative in {@link CANNParser#boolean_expr}.
	 * @param ctx the parse tree
	 */
	void enterGreaterThanComparison(CANNParser.GreaterThanComparisonContext ctx);
	/**
	 * Exit a parse tree produced by the {@code greaterThanComparison}
	 * labeled alternative in {@link CANNParser#boolean_expr}.
	 * @param ctx the parse tree
	 */
	void exitGreaterThanComparison(CANNParser.GreaterThanComparisonContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code boolParenExpr}
	 * labeled alternative in {@link CANNParser#boolean_expr}.
	 * @param ctx the parse tree
	 */
	void enterBoolParenExpr(CANNParser.BoolParenExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code boolParenExpr}
	 * labeled alternative in {@link CANNParser#boolean_expr}.
	 * @param ctx the parse tree
	 */
	void exitBoolParenExpr(CANNParser.BoolParenExprContext ctx);
	/**
