...
public interface CANNVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitBoolIdentifier(CANNParser.BoolIdentifierContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitGreaterThanComparison(CANNParser.GreaterThanComparisonContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code boolParenExpr}
	 * labeled alternative in {@link CANNParser#boolean_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBoolParenExpr(CANNParser.BoolParenExprContext ctx);
	/**
